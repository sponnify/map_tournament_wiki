...
{: .important }
Teams must maintain these requirements throughout the tournament. For complete registration requirements, see the [Registration]({{ site.baseurl }}/tournament-info/entry-info/registration/) page.
...
{: .highlight }
Make sure your team knows what they're competing for. For complete prize information and bounty rules, see the [Prizes]({{ site.baseurl }}/tournament-info/tournament-structure/prizes/) page.
