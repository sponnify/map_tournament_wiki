...
nav_order: 2
permalink: /tournament-info/tournament-structure/gimmicks/
---
...
- Teams must have **exactly 4 players** participate in the warmup - *no exceptions will be made*.
...
#### Example Scheduling Messages

Participating in the warmup gimmick:
![Participating in warmup gimmick](/assets/images/warmup-participating.png)

Declining the warmup gimmick:
![Declining warmup gimmick](/assets/images/warmup-declining.png)

When a mapper is not available:
![Mapper unavailable](/assets/images/warmup-mapper-unavailable.png)
