...
layout: page
title: Rules
parent: Core Information
grand_parent: Tournament Info
nav_order: 2
permalink: /tournament-info/core-info/rules/
...
4. **Team Requirements**:
   ...
   - Team names must be **suitable and respectful**.
   - Teams may provide a **team banner/logo**.
   - All team assets must be **appropriate for all ages**.
   - Admins have the authority to change or remove any inappropriate team names or visual assets.
...
10. **Staff participation**:
    - **Roles Allowed to Participate as Players**: Referees, Commentators, Streamers.
    - **Roles Not Allowed to Participate as Players**: Hosts, Admins, Sheeters, Poolers, Playtesters, Replayers, Graphic Designers.
...
### During Matches
- If a player exhibits toxic or unsportsmanlike behavior during a match, the referee will issue a **warning** and notify an admin if necessary.  
- If the referee does not identify any reportable behavior, players can bring the issue to admins directly.  
- Unless admins decide otherwise, the match will continue as normal, and any consequences will be determined after the match.

### Outside Matches
Behavior issues outside of matches should be reported to admins directly.  
Provide as much detail as possible to assist with the investigation.
...
- Gather as much evidence as possible before reporting (screenshots, timestamps, chat logs).
- Provide a clear description of the incident.
- Include any relevant context.

### Investigation Process
All reports will be investigated thoroughly. The depth and scope of the investigation will be determined by:
...
- Deliver a ruling in a timely manner.
- Handle each case appropriately based on context.

> **Note**: All reports are treated **confidentially** and taken seriously.
...
Violations of tournament guidelines or the guidelines of any service used by the tournament (e.g., Twitch, Discord) may result in the following penalties:
